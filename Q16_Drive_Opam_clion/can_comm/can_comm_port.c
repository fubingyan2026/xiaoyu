...
uint32_t can_comm_get_receive_level(hal_fdcan_instance_t instance, uint8_t fifo_address)
{
...
bool can_comm_receive(hal_fdcan_instance_t instance, hal_fdcan_message_t *message)
{
    ensure_fdcan_initialized();
...
bool can_comm_send(hal_fdcan_instance_t instance, const hal_fdcan_message_t *message)
{
    ensure_fdcan_initialized();
