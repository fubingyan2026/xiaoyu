...
typedef struct {
  ...
  bool (*send)(hal_uart_instance_e instance, const uint8_t *data,
               uint16_t size);
  bool (*receive)(hal_uart_instance_e instance, uint8_t *data, uint16_t size);
  uint16_t (*send_async)(hal_uart_instance_e instance, const uint8_t *data,
                         uint16_t size);
  uint16_t (*receive_async)(hal_uart_instance_e instance, uint8_t *data,
                            uint16_t size);
  bool (*send_dma)(hal_uart_instance_e instance, const uint8_t *data,
                   uint32_t size);
  bool (*receive_dma)(hal_uart_instance_e instance, uint8_t *data,
                      uint32_t size);
  bool (*receive_dma_to_idle)(hal_uart_instance_e instance, uint8_t *data,
                              uint32_t size);
  ...
  bool (*set_baudrate)(hal_uart_instance_e instance,
...
bool hal_uart_send(hal_uart_instance_e instance, const uint8_t *data,
                   uint16_t size);
bool hal_uart_receive(hal_uart_instance_e instance, uint8_t *data,
                      uint16_t size);
uint16_t hal_uart_send_async(hal_uart_instance_e instance, const uint8_t *data,
                             uint16_t size);
uint16_t hal_uart_receive_async(hal_uart_instance_e instance, uint8_t *data,
                                uint16_t size);
bool hal_uart_send_dma(hal_uart_instance_e instance, const uint8_t *data,
                       uint32_t size);
bool hal_uart_receive_dma(hal_uart_instance_e instance, uint8_t *data,
                          uint32_t size);
bool hal_uart_receive_dma_to_idle(hal_uart_instance_e instance, uint8_t *data,
                                  uint32_t size);
...
bool hal_uart_set_baudrate(hal_uart_instance_e instance,
                           hal_uart_baudrate_e baudrate);
