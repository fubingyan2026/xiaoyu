...
typedef struct {
  ...
  bool (*set_duty_cycle)(uint8_t timer_instance, hal_tim_pwm_channel_e channel,
                         uint32_t duty_cycle);
  bool (*set_frequency)(uint8_t timer_instance, hal_tim_pwm_channel_e channel,
                        uint32_t frequency);
  uint32_t (*get_duty_cycle)(uint8_t timer_instance,
                             hal_tim_pwm_channel_e channel);
  uint32_t (*get_frequency)(uint8_t timer_instance,
                            hal_tim_pwm_channel_e channel);
} hal_tim_pwm_ops_t;
