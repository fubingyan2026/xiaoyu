...
#ifndef FSM_LINEAR_HALL_ALIGENED_H
#define FSM_LINEAR_HALL_ALIGENED_H
 ...
 */
typedef enum {
    FSM_LINEAR_HALL_ALIGENED_STATE_NONE = 0, /**< 空闲 */
    FSM_LINEAR_HALL_ALIGENED_STATE_FILTER, /**< 滤波器稳定 */
    FSM_LINEAR_HALL_ALIGENED_STATE_ALIGN, /**< 电机对齐 */
    FSM_LINEAR_HALL_ALIGENED_STATE_ROTATION, /**< 旋转采样 */
    FSM_LINEAR_HALL_ALIGENED_STATE_PROCESS, /**< 参数计算并保存 */
    FSM_LINEAR_HALL_ALIGENED_STATE_DONE, /**< 校准完成 */
    FSM_LINEAR_HALL_ALIGENED_STATE_COUNT /**< 状态总数（FSM 哨兵） */
} fsm_linear_hall_aligened_state_t;
...
#endif /* FSM_LINEAR_HALL_ALIGENED_H */
