...
static const uint16_t crc16_table[256U] = {
    ...
    0xC5C1U, 0xC481U, 0x0440U, 0xCC01U, 0x0CC0U, 0x0D80U, 0xCD41U, 0xF000U, 0x30C1U, 0x3180U, 0xC241U, 0xC601U, 0x06C0U,
    0x0780U, 0xC741U, 0x0500U, 0xC5C1U, 0xC481U, 0x0440U, 0x8C01U, 0x4CC0U, 0x4D80U, 0x8D41U, 0x8800U, 0x48C1U, 0x4980U,
    0x8941U, 0x7800U, 0x38C1U, 0x3980U, 0x7941U, 0x2800U, 0x18C1U, 0x1980U, 0x5941U, 0xB000U, 0x70C1U, 0x7180U, 0xB141U,
    0xA000U, 0x60C1U, 0x6180U, 0xA141U, 0x9000U, 0x50C1U, 0x5180U, 0x9141U, 0x8C01U, 0x4CC0U, 0x4D80U, 0x8D41U, 0x8800U,
    0x48C1U, 0x4980U, 0x8941U, 0x7800U, 0x38C1U, 0x3980U, 0x7941U, 0x2800U, 0x18C1U, 0x1980U, 0x5941U, 0xF000U, 0x70C1U,
    0x7180U, 0xB141U, 0xA000U, 0x60C1U, 0x6180U, 0xA141U, 0x9000U, 0x50C1U, 0x5180U, 0x9141U, 0xCC01U, 0x0CC0U, 0x0D80U,
    0xCD41U, 0xC601U, 0x06C0U, 0x0780U, 0xC741U, 0x0500U, 0xC5C1U, 0xC481U, 0x0440U, 0xC0C1U, 0x0001U, 0xC181U, 0x0140U,
    0xC301U, 0x03C0U, 0x0280U, 0xC241U, 0xC601U, 0x06C0U, 0x0780U, 0xC741U, 0x0500U, 0xC5C1U, 0xC481U, 0x0440U, 0xCC01U,
    0x0CC0U, 0x0D80U, 0xCD41U, 0xF000U, 0x30C1U, 0x3180U, 0xC241U, 0xC601U, 0x06C0U, 0x0780U, 0xC741U, 0x0500U, 0xC5C1U,
    0xC481U, 0x0440U, 0x8C01U, 0x4CC0U, 0x4D80U, 0x8D41U, 0x8800U, 0x48C1U, 0x4980U, 0x8941U, 0x7800U, 0x38C1U, 0x3980U,
    0x7941U, 0x2800U, 0x18C1U, 0x1980U, 0x5941U, 0xB000U, 0x70C1U, 0x7180U, 0xB141U, 0xA000U, 0x60C1U, 0x6180U, 0xA141U,
    0x9000U, 0x50C1U, 0x5180U, 0x9141U, 0x8C01U, 0x4CC0U, 0x4D80U, 0x8D41U, 0x8800U, 0x48C1U, 0x4980U, 0x8941U, 0x7800U,
    0x38C1U, 0x3980U, 0x7941U, 0x2800U, 0x18C1U, 0x1980U, 0x5941U, 0xF000U, 0x70C1U, 0x7180U, 0xB141U, 0xA000U, 0x60C1U,
    0x6180U, 0xA141U, 0x9000U, 0x50C1U, 0x5180U, 0x9141U, 0xCC01U, 0x0CC0U, 0x0D80U, 0xCD41U, 0xC601U, 0x06C0U, 0x0780U,
    0xC741U, 0x0500U, 0xC5C1U, 0xC481U, 0x0440U, 0xC0C1U, 0x0001U, 0xC181U, 0x0140U, 0xC301U, 0x03C0U, 0x0280U, 0xC241U,
    0xC601U, 0x06C0U, 0x0780U, 0xC741U, 0x0500U, 0xC5C1U, 0xC481U, 0x0440U, 0xCC01U, 0x0CC0U, 0x0D80U, 0xCD41U, 0xF000U,
    0x30C1U, 0x3180U, 0xC241U, 0xC601U, 0x06C0U, 0x0780U, 0xC741U, 0x0500U, 0xC5C1U, 0xC481U, 0x0440U, 0x8C01U, 0x4CC0U,
    0x4D80U, 0x8D41U, 0x8800U, 0x48C1U, 0x4980U, 0x8941U, 0x7800U, 0x38C1U, 0x3980U, 0x7941U, 0x2800U, 0x18C1U, 0x1980U,
    0x5941U, 0xB000U, 0x70C1U, 0x7180U, 0xB141U, 0xA000U, 0x60C1U, 0x6180U, 0xA141U,
};
 ...
 * @return uint16_t 帧长度
 */
static uint16_t s7_build_frame(uint8_t msg_type, uint8_t func_code, const uint8_t *data, uint16_t len, uint8_t *output)
{
 ...
 * @return int 0成功,其他失败
 */
static int cmd_ping_handler(uint8_t func_code, uint8_t *data, uint16_t len, uint8_t *response, uint16_t *resp_len)
{
    (void)func_code;
    (void)data;
    (void)len;
 ...
 * @return int 0成功,其他失败
 */
static int cmd_get_version_handler(uint8_t func_code, uint8_t *data, uint16_t len, uint8_t *response,
                                   uint16_t *resp_len)
{
    (void)func_code;
    (void)data;
 ...
 * @return int 0成功,其他失败
 */
static int cmd_reset_handler(uint8_t func_code, uint8_t *data, uint16_t len, uint8_t *response, uint16_t *resp_len)
{
    (void)func_code;
    (void)data;
    (void)len;
 ...
 * @return int 0成功,其他失败
 */
static int cmd_get_status_handler(uint8_t func_code, uint8_t *data, uint16_t len, uint8_t *response, uint16_t *resp_len)
{
    (void)func_code;
    (void)data;
    (void)len;
 ...
 * @return int 0成功,其他失败
 */
static int cmd_get_state_handler(uint8_t func_code, uint8_t *data, uint16_t len, uint8_t *response, uint16_t *resp_len)
{
    (void)func_code;
    (void)data;
    (void)len;
 ...
 * @return int 0成功,其他失败
 */
static int cmd_set_current_handler(uint8_t func_code, uint8_t *data, uint16_t len, uint8_t *response,
                                   uint16_t *resp_len)
{
    (void)func_code;
    (void)response;
 ...
 * @return int 0成功,其他失败
 */
static int cmd_set_velocity_handler(uint8_t func_code, uint8_t *data, uint16_t len, uint8_t *response,
                                    uint16_t *resp_len)
{
    (void)func_code;
    (void)response;
 ...
 * @return int 0成功,其他失败
 */
static int cmd_set_position_handler(uint8_t func_code, uint8_t *data, uint16_t len, uint8_t *response,
                                    uint16_t *resp_len)
{
    (void)func_code;
    (void)response;
    *resp_len = 0U;
    ...
    int32_t position = (int32_t)((uint32_t)data[0U] | ((uint32_t)data[1U] << 8) | ((uint32_t)data[2U] << 16) |
                                 ((uint32_t)data[3U] << 24));
 ...
 * @return int 0成功,其他失败
 */
static int cmd_stop_handler(uint8_t func_code, uint8_t *data, uint16_t len, uint8_t *response, uint16_t *resp_len)
{
    (void)func_code;
    (void)data;
    (void)len;
 ...
 * @return int 0成功,其他失败
 */
static int cmd_start_handler(uint8_t func_code, uint8_t *data, uint16_t len, uint8_t *response, uint16_t *resp_len)
{
    (void)func_code;
    (void)data;
    (void)len;
 ...
 * @return int 0成功,其他失败
 */
static int cmd_start_calib_handler(uint8_t func_code, uint8_t *data, uint16_t len, uint8_t *response,
                                   uint16_t *resp_len)
{
    (void)func_code;
    (void)data;
 ...
 * @return int 0成功,其他失败
 */
static int cmd_get_calib_status_handler(uint8_t func_code, uint8_t *data, uint16_t len, uint8_t *response,
                                        uint16_t *resp_len)
{
    (void)func_code;
    (void)data;
    ...
    if ((state == (uint8_t)FOC_SM_STATE_ALIGN) || (state == (uint8_t)FOC_SM_STATE_ALIGNMENT))
    {
 ...
 * @return int 0成功,其他失败
 */
static int cmd_get_calib_data_handler(uint8_t func_code, uint8_t *data, uint16_t len, uint8_t *response,
                                      uint16_t *resp_len)
{
    (void)func_code;
    (void)data;
 ...
 * @return int 0成功,其他失败
 */
static int cmd_set_calib_data_handler(uint8_t func_code, uint8_t *data, uint16_t len, uint8_t *response,
                                      uint16_t *resp_len)
{
    (void)func_code;
    (void)response;
 ...
 * @return int 0成功,其他失败
 */
static int cmd_clear_calib_handler(uint8_t func_code, uint8_t *data, uint16_t len, uint8_t *response,
                                   uint16_t *resp_len)
{
    (void)func_code;
    (void)data;
 ...
 * @return int 0成功,其他失败
 */
static int cmd_get_params_handler(uint8_t func_code, uint8_t *data, uint16_t len, uint8_t *response, uint16_t *resp_len)
{
    (void)func_code;
 ...
 * @return int 0成功,其他失败
 */
static int cmd_set_params_handler(uint8_t func_code, uint8_t *data, uint16_t len, uint8_t *response, uint16_t *resp_len)
{
    (void)func_code;
    (void)data;
    (void)response;
 ...
 * @return int 0成功,其他失败
 */
static int cmd_start_stream_handler(uint8_t func_code, uint8_t *data, uint16_t len, uint8_t *response,
                                    uint16_t *resp_len)
{
    (void)func_code;
    (void)response;
 ...
 * @return int 0成功,其他失败
 */
static int cmd_stop_stream_handler(uint8_t func_code, uint8_t *data, uint16_t len, uint8_t *response,
                                   uint16_t *resp_len)
{
    (void)func_code;
    (void)data;
 ...
 * 命令处理表
 *============================================================================*/
typedef int (*protocol_cmd_handler_t)(uint8_t func_code, uint8_t *data, uint16_t len, uint8_t *response,
                                      uint16_t *resp_len);
...
void usart_protocol_process_frame(uint8_t *data, uint16_t len)
{
    ...
    for (uint16_t i = 0U; i < CMD_TABLE_SIZE; i++)
    {
        ...
        {
            ret = s_cmd_table[i].handler(func_code, payload, payload_len, response, &resp_len);
            break;
        }
    }
...
void usart_protocol_stream_task(void)
{
    ...
    (void)usart_protocol_send_response(MSG_RESPONSE, FUNC_GET_STATUS, (uint8_t *)&stream, sizeof(StreamData_t));
}
