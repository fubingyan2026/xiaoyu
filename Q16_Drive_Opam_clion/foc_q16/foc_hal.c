...
void foc_hal_pwm_update(foc_hal_t* hal, q16_16_t ta, q16_16_t tb, q16_16_t tc, q16_16_t td)
{
    ...
    uint32_t ta_counts = (uint32_t)q16_16_mul(ta, INT_TO_Q16_16(hal->config.pwm_period_counts));
    uint32_t tb_counts = (uint32_t)q16_16_mul(tb, INT_TO_Q16_16(hal->config.pwm_period_counts));
    uint32_t tc_counts = (uint32_t)q16_16_mul(tc, INT_TO_Q16_16(hal->config.pwm_period_counts));
    uint32_t td_counts = (uint32_t)q16_16_mul(td, INT_TO_Q16_16(hal->config.pwm_period_counts));
