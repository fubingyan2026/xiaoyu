...
uint32_t can_comm_get_receive_level(hal_fdcan_instance_e instance, uint8_t fifo_address)
{
    return hal_fdcan_get_receive_level(instance, fifo_address);
}

uint32_t can_comm_get_send_level(hal_fdcan_instance_e instance)
{
    return hal_fdcan_get_send_fifo_level(instance);
}

bool can_comm_receive(hal_fdcan_instance_e instance, hal_fdcan_message_t *message)
{
    return hal_fdcan_receive(instance, message);
}

bool can_comm_send(hal_fdcan_instance_e instance, const hal_fdcan_message_t *message)
{
    return hal_fdcan_send(instance, message);
}
