...
typedef struct
{
    ...
    bool (*send)(hal_fdcan_instance_e instance, const hal_fdcan_message_t* message);
    ...
    bool (*set_filter)(hal_fdcan_instance_e instance, const hal_fdcan_filter_t* filter);
